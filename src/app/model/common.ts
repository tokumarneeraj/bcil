...
{tabelname:"MOU Proposed By Legal Manager",permission:"mou_proposed_by_lm.view", name: 'mou_porposed_by_lm', value: 'S104', createdBy: "Tes4",forwordtitle:"Forward to BDM/IPM",backtitle:"Forward to LM", forward: "S110", forwardCheck: false, forwardText: 'Forward', back: true, backStatus: "S103",approvetitle:"Forward to Bdo/IPM", approvedvalue: 'S110', approved: true, approvedText: "Approved", backbuttonText: 'Change Req',permissionforword:new commondata().CanviewMou_proposed_by_lm_forword_buttonPermission ,permissionbutton1:new commondata().CanviewMou_proposed_by_lm_change_required_buttonPermission},
...
{tabelname:"init",permission:"tto_req_approved.view", name: 'tta_init', value: 'S113', createdBy: "Tes3", forward: "S106", forwardCheck: true, forwardText: 'Forward', back: false ,permissionforword:new commondata().Canviewbdoassigned_forword_buttonPermission},
 ...
 public ttaarray(){ return [
  {stage:'tta', tablename:'', name: 'ViewMouAll', value: 'S108', formHeader: 'Assignment and Tech. Disclosure Form',permission:"tto_req_approved.view" },
  {stage:'tta', tablename:'TTA INIT',name: 'tta_init', value: 'S113', formHeader: 'Assign to BDM',permission:"tta_init.view" },
  ...
  {stage:'tta', tablename:'TTA Techb And Flier Approved by Admin',name: 'tta_techb_and_flier_approved_by_admin', value: 'S126', formHeader: 'Application Forward',permission:"tta_techb_and_flier_approved_by_admin.view" },
  {stage:'tta', tablename:'TTA Techb And Flier Approved by Scientist',name: 'tta_techb_and_flier_approved_by_scientist', value: 'S127', formHeader: 'Application Forward',permission:"tta_techb_and_flier_approved_by_scientist.view" },
  {stage:'tta', tablename:'TTA Change Req by Scientist',name: 'tta_change_req_by_scientist', value: 'S128', formHeader: 'Application Forward',permission:"tta_change_req_by_scientist.view" },
  ...
  {stage:'tta', tablename:'NO INTEREST RECEIVED',name: 'no_interest_received', value: 'S131', formHeader: 'Application Forward',permission:"" },
