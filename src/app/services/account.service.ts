...
export class AccountService {
  ...
  GetUserpermissiontoAdduser(role: string, roletype: string) {
    return this.accountEndpoint.GetUserpermissiontoAdduser<any>(role, roletype);
  }
  UserpermissiontoAdduser(userpermissiontoaddUser: ViewuserpermissiontoaddUser[]) {
    return this.accountEndpoint.UserpermissiontoAdduser<any>(userpermissiontoaddUser);
  }
